...
fig.suptitle("Symmetric Bell-Shaped Histograms with Incorrect Negatively Skewed Curves", fontsize=16)
...
curve_color = 'black'
linewidth = 2
skewness = -5  # Negative skewness parameter (negative value creates left skew)
...
plt.tight_layout()
plt.savefig("bell_shaped_histograms_with_neg_skewed_curves.png", dpi=300, bbox_inches='tight')
plt.show()